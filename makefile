...
tpga4: tpga4.o tpga4_ex1.o vertex.o int_list.o tpga4_ex2.o int_stack.o
	$(CC) $(GL_LIBDIR) tpga4.o tpga4_ex1.o vertex.o int_list.o tpga4_ex2.o int_stack.o $(GL_LIBRARIES) -o $@
